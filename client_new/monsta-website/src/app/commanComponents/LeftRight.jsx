      ...
      <div className='Scroll-left'>
        <div className="widget_list ">
          ...
          <ul className='p-0'>
            ...
            <li>
              <input className="form-check-input" type="checkbox" />
              <label className="form-check-label" for="categories27">Nest Of Tables</label>
            </li>
          ...
          <ul className='p-0'>
            ...
            <li>
              ...
              <label class="form-check-label" >Side and End Tables</label>
            </li>
        ...
        <div className="widget_list">
          ...
          <ul className='p-0'>
            ...
            <li>
              <input class="form-check-input" type="checkbox" />
              <label class="form-check-label" for="categories27">Nest Of Tables</label>
            </li>
      ...
      <Col>
        ...
        <div class="single_product">
          <div class="product_thumb">
            <Link class="primary_img" href={`/product-details/${"your_product_name"}`}>
            ...
            <Link class="secondary_img" href={`/product-details/${"your_product_name"}`}>
              <img src="https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/products/1608312103476Dorian%20Shoe%20Rack_.jpg" className='img-fluid' alt="" />
            </Link>
          </div>
          <div class="product_content">
            ...
            <div class="price_box">
              <span class="old_price">Rs. 3,500</span>
              <span class="current_price">Rs. 2,800</span>
            </div>

            <div class="action_links mt-3">
              <ul>
                <li>
                  <a class="wishlist_tooltip" data-placement="top" title="Add to Wishlist" data-bs-toggle="tooltip">
                    <span class="icon">
                      <img src="https://wscubetech.co/Assignments/furniture/public/frontend/img/icon/heart-regular.svg" class="wishlist_img" className='img-fluid' />
                    </span>
                  </a>
                </li>
                <li class="add_to_cart">
                  <a title="Add to Cart" id="product_14">
                    <div class="cartShow">add to cart</div>
                    <div class="cartHide" style={{ display: "none" }} >Loading...</div>
                  </a>
                </li>
              </ul>
            </div>
