          ...
          <Row>
            <Col lg={6} md={12}>
              <div className="contact_message content">
                ...
                <p></p>
                <ul className='p-0'>
                  <li><FaFax />  Address : Claritas est etiam processus dynamicus</li>
            ...
            <Col lg={6} md={12}>
              <div className="contact_message form">
                ...
                <form method="POST"  id="contact-form" className="bv-form" autoComplete='true' noValidate="novalidate">
                  
                 
                  <p className="form-group has-feedback">

                    <label> Your Name (required)</label>
                    <input name="name" placeholder="Name *" type="text" data-bv-field="name" /> </p>
                      
                  <p className="form-group has-feedback">
                    <label>  Your Email (required)</label>

                    <input name="email" placeholder="Email *" type="email" data-bv-field="email" /> </p>

                      

                  <p className="form-group has-feedback">
                    <label>  Your Mobile Number (required)</label>
                    <input name="mobile" placeholder="Mobile Number *" type="text" data-bv-field="mobile" /> </p>
                     

                  <p className="form-group has-feedback">
                    <label>  Subject</label>
                    <input name="subject" placeholder="Subject *" type="text" data-bv-field="subject" /> </p>
